  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-7 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="{{ asset('assets/svg/icons/undraw_welcome_cats_thqn.svg') }}" alt="auth-login-cover" class="img-fluid my-5 auth-illustration">
        ...
        <div class="app-brand justify-content-center mb-5">
          <a href="{{url('/home')}}" class="app-brand-link">
            <span class="app-brand-logo demo">
              <img src="{{ asset('assets/svg/icons/osn.webp') }}" width="100px" height="60px" alt="Brand Logo" class="img-fluid">
            </span>
{{--            <span class="app-brand-text demo text-body fw-bold">OSN</span>--}}
          </a>
        </div>
        <!-- /Logo -->
